...
if [ $1 = 1 ]; then
    ...
    systemctl enable tpcsserdaemon.service
    systemctl enable twpserdaemon.service
fi
...
if [ $1 = 0 ]; then
    ...
    systemctl disable tpcsserdaemon.service
    systemctl disable twpserdaemon.service
fi
